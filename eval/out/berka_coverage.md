...
Evidence classes: A 43, B 3, C 25.
...
|---|---|---|---|---|---|---|---|
| 1 | `avg_monthly_inflow` | computable | A (real_validated) | 100% | — | — | Berka: computed on real accounts, point-in-time before loan.date (absolute CZK; never in the comparison set) |
| 2 | `inflow_count_per_month` | computable | A (real_validated) | 100% | — | — | Berka: computed on real accounts, point-in-time before loan.date |
| 3 | `inflow_regularity_score` | computable | A (real_validated) | 100% | insufficient_events 1 | — | Berka: inflow interval CV on real accounts |
| 4 | `revenue_growth_rate_90d` | computable | A (real_validated) | 99% | insufficient_history 36, near_zero_denominator 8 | — | Berka: computed on real accounts, point-in-time before loan.date |
| 5 | `largest_single_source_ratio` | partial | A (real_validated) | 37% | insufficient_events 2495 | 0.29 (median value share with a counterparty) | Berka: bank+account partner key (Probe 2 PASS); coverage share reported |
| 6 | `avg_monthly_outflow` | computable | A (real_validated) | 100% | — | — | Berka: computed on real accounts, point-in-time before loan.date (absolute CZK; never in the comparison set) |
| 7 | `outflow_count_per_month` | computable | A (real_validated) | 100% | — | — | Berka: computed on real accounts, point-in-time before loan.date |
| 8 | `recurring_expense_ratio` | computable | A (real_validated) | 100% | — | — | Berka: declared `order` table vs inferred classification (§8.4) |
| 9 | `expense_growth_rate_90d` | computable | A (real_validated) | 98% | insufficient_history 36, near_zero_denominator 25 | — | Berka: computed on real accounts, point-in-time before loan.date |
| 10 | `top_expense_category_share` | computable | A (real_validated) | 100% | — | — | Berka: category from k_symbol/operation codes |
| 11 | `cash_flow_volatility` | computable | A (real_validated) | 100% | — | — | Berka: computed on real accounts, point-in-time before loan.date |
| 12 | `inflow_outflow_ratio` | computable | A (real_validated) | 100% | — | — | Berka: computed on real accounts, point-in-time before loan.date |
| 13 | `days_negative_balance_90d` | partial | A (real_validated) | 100% | — | — | Berka: 6.4% of accounts ever negative (Probe 1 PASS) |
| 14 | `overdraft_events_90d` | partial | A (real_validated) | 100% | — | — | Berka: Probe 1 PASS |
| 15 | `volatility_index` | partial | A (real_validated) | 100% | — | — | Berka: composite of 11–14; formula PROPOSED (DECISIONS.md entry 8) |
| 16 | `avg_daily_balance` | computable | A (real_validated) | 100% | — | — | Berka: computed on real accounts, point-in-time before loan.date (absolute CZK) |
| 17 | `min_daily_balance_90d` | computable | A (real_validated) | 100% | — | — | Berka: computed on real accounts, point-in-time before loan.date (absolute CZK) |
| 18 | `current_runway_days` | computable | A (real_validated) | 100% | not_applicable 2789 | — | Berka: computed on real accounts, point-in-time before loan.date |
| 18b | `runway_days_avg_balance` | computable | A (real_validated) | 100% | not_applicable 2789 | — | Berka: computed on real accounts, point-in-time before loan.date |
| 19 | `liquidity_trend_slope` | computable | A (real_validated) | 100% | — | — | Berka: computed on real accounts, point-in-time before loan.date (currency/day; never in the comparison set) |
| 20 | `unique_counterparties_count` | partial | A (real_validated) | 84% | insufficient_events 642 | 0.29 (median value share with a counterparty) | Berka: Probe 2 PASS; coverage share reported |
| 21 | `counterparty_concentration_index` | partial | A (real_validated) | 84% | insufficient_events 642 | 0.29 (median value share with a counterparty) | Berka: Probe 2 PASS; coverage share reported |
| 22 | `new_counterparty_ratio_30d` | partial | A (real_validated) | 84% | insufficient_events 645 | 0.29 (median value share with a counterparty) | Berka: Probe 2 PASS; coverage share reported |
...
| 26 | `governance_transparency_score` | computable | A (real_validated) | 100% | not_implemented 3983 | — | reuses features 3 and 11 (both A); weighting formula not yet signed off — not_implemented |
...
| 32 | `coverage_days_90d` | computable | A (real_validated) | 100% | — | — | Berka: computed on real accounts, point-in-time before loan.date |
| 33 | `data_gap_ratio` | partial | A (real_validated) | 100% | — | — | Berka: operating-day calendar is Sat/Sun for external_real (Czech), Fri/Sat for synthetic |
...
| 41 | `financing_outflow_ratio` | computable | A (real_validated) | 80% | near_zero_denominator 806 | — | Berka: k_symbol=UVER loan payments (code path); MCC path does not exist on real data (§8.4) |
| 42 | `installment_capacity_sar` | computable | A (real_validated) | 100% | — | — | derived from 1, 6, 49 — all A |
| 43 | `inflow_break_recency_days` | computable | A (real_validated) | 99% | no_break_detected 1527, insufficient_history 36 | — | Berka: computed on real accounts, point-in-time before loan.date |
| 44 | `net_flow_autocorr_lag7` | computable | A (real_validated) | 100% | — | — | Berka: computed on real accounts, point-in-time before loan.date |
| 45 | `counterparty_persistence_ratio` | partial | A (real_validated) | 37% | insufficient_events 2471, insufficient_history 36 | 0.29 (median value share with a counterparty) | Berka: Probe 2 PASS; coverage share reported |
| 46 | `circular_counterparty_count` | partial | A (real_validated) | 84% | insufficient_events 642 | 0.29 (median value share with a counterparty) | Berka: Probe 2 PASS; coverage share reported |
| 47 | `downside_semideviation_90d` | computable | A (real_validated) | 100% | — | — | Berka: computed on real accounts, point-in-time before loan.date |
| 48 | `upside_semideviation_90d` | computable | A (real_validated) | 100% | — | — | Berka: computed on real accounts, point-in-time before loan.date |
| 49 | `flow_asymmetry_ratio` | computable | A (real_validated) | 100% | — | — | Berka: computed on real accounts, point-in-time before loan.date |
| 50 | `revenue_shock_absorption_pct` | computable | A (real_validated) | 100% | — | — | Berka: fixed costs = declared standing-order outflow, variable = the rest |
| 51 | `fixed_obligation_coverage_months` | computable | A (real_validated) | 80% | near_zero_denominator 807 | — | Berka: computed on real accounts, point-in-time before loan.date |
| 52 | `liquidity_hazard_30d` | computable | A (real_validated) | 100% | — | — | Berka: block-bootstrap hazard over real net flows (naive trailing-mean model) |
| 53 | `liquidity_hazard_60d` | computable | A (real_validated) | 100% | — | — | same as 52 |
| 54 | `liquidity_hazard_90d` | computable | A (real_validated) | 100% | — | — | same as 52 |
...
| 60 | `committed_monthly_outflow` | computable | A (real_validated) | 100% | — | — | Berka: `order` table, declared standing orders (frequency measured from executions) |
| 61 | `obligation_coverage_ratio` | computable | A (real_validated) | 91% | not_applicable 482, near_zero_denominator 341 | — | Berka: `order` table + real inflow |
...
| 68 | `max_consecutive_overdraft_days` | partial | A (real_validated) | 100% | — | — | Berka: longest run of consecutive negative-balance days on real accounts (Probe 1 PASS) |
